...
namespace libf {
    ...
    public:
        ...
        /**
         * Sets whether or not class frequencies shall be used
         */
        void setUseClassFrequency(bool _useClassFrequency)
        {
          useClassFrequency = _useClassFrequency;
        }
        /**
        ...
        void updateMultiHistograms(DecisionTree* tree, const DataStorage* storage) const;

        void useMultiLabelLayers(bool use_multi){
            multipleLabelLayers = use_multi;
        }
    ...
    private:
        ...
        bool useBootstrap;
        /**
         * Whether or not class frequencies are used to weight the entropy.
         */
        bool useClassFrequency;
        /**
