...
namespace libf {
    ...
    public:
        ...
        virtual void multiClassLogPosterior(const DataPoint* x, std::vector<std::vector<float> > & probabilities) const = 0;
    ...
    public:
        ...
        /**
         * Returns the class log posterior p(c | x) for all layers.
         */
        virtual void multiClassLogPosterior(const DataPoint* x, std::vector<std::vector<float> > & probabilities) const;
        ...
        std::vector<std::vector<float> > & getMultiHistogram(int node)
        {
            return multi_histograms[node];
        }
        ...
        const std::vector<std::vector<float> > & getMultiHistogram(int node) const
        {
            return multi_histograms[node];
        }
    ...
    private:
        ...
        std::vector< std::vector< std::vector<float> > > multi_histograms;
    };
